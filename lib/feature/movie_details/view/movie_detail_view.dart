...
class MovieDetailView extends HookWidget {
  ...
  Widget build(BuildContext context) {
      ...
      // );
      context.read<MovieViewmodel>().getMovieDetails(movieId);
      // return null;
    }, []);
    return Scaffold(
      body:Consumer<MovieViewmodel>(builder: (ctx, viewModel, index) {
        final MovieDetailsModel movieDetailsModel =viewModel.movieDetailResponse.data!;
            ...
            slivers: [
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: Stack(
                    children: [
                   Image.network("https://image.tmdb.org/t/p/w500${movieDetailsModel.backdropPath}" ?? "",
                        height: 300.h,
                        width: 1.sw,
                        fit: BoxFit.cover), 
                      // Image.asset(
